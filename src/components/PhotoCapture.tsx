...
const PhotoCapture: React.FC<PhotoCaptureProps> = ({ onPhotoTaken, isLoading }) => {
  ...
  // Simple image processing - no complex resizing
  ...
  return (
    <>
      <input
        ...
        type="file"
        accept="image/*"
        // Removed capture="environment" - now allows camera roll selection
...
export default PhotoCapture;import React, { useRef, ChangeEvent, useState } from 'react';
